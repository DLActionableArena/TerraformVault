...
# RESULT={
# "arn:aws:secretsmanager:us-east-2:386827457018:secret:application3-2TCryq": "terraform-20251216170041160200000003",
# "arn:aws:secretsmanager:us-east-2:386827457018:secret:application1-uycBtf": "terraform-20251216170041159600000001",
# "arn:aws:secretsmanager:us-east-2:386827457018:secret:application2-BTq8co": "terraform-20251216170041159600000002"
# }
...
variable "VAULT_SECRETS_ARN" {
  description = "A map of Vault secrets versions"
  type        = map(string)
  default = {
    application1 = "arn:aws:secretsmanager:us-east-2:386827457018:secret:application1-uycBtf"
    application2 = "arn:aws:secretsmanager:us-east-2:386827457018:secret:application2-BTq8co"
    application3 = "arn:aws:secretsmanager:us-east-2:386827457018:secret:application3-2TCryq"
  }
}
...
#   # to = aws_secretsmanager_secret_version.imported_aws_secrets["application3"]
#   identity = {
#     secret_id  = "arn:aws:secretsmanager:us-east-2:386827457018:secret:application3-2TCryq"
